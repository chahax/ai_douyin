...
- **Python 版本**：必须使用 **conda Python 3.9**
  ```
  C:/Users/c/.conda/envs/GPTSoVits/python.exe
  ```
...
conda_python = "C:/Users/c/.conda/envs/GPTSoVits/python.exe"
sdk_root = "./GPT_SoVITS"  # 或使用绝对路径如 D:/IT/GPT-SoVITS-main/GPT-SoVITS-main
script = """
import sys, os
os.chdir(r'{}')
sys.path.insert(0, r'{}')
...
```bash
"C:/Users/c/.conda/envs/GPTSoVits/python.exe" --version
# 输出应该是: Python 3.9.23

# 然后测试 import
"C:/Users/c/.conda/envs/GPTSoVits/python.exe" -c "from sdk.tts_client import ClientConfig, TTSClient; print('SDK OK')"
```
...
```env
# .env
GPT_SOVITS_SDK_ROOT=./GPT_SoVITS  # 或 D:/IT/GPT-SoVITS-main/GPT-SoVITS-main
